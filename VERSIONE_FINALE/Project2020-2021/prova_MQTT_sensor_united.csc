...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      org.contikios.cooja.contikimote.ContikiMoteType
      <identifier>mtype291</identifier>
    ...
    <motetype>
      org.contikios.cooja.contikimote.ContikiMoteType
      <identifier>mtype948</identifier>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/Project2020-2021/MQTT_sensor_nodes/mqtt-client_light_temperature.c</source>
      <commands>make mqtt-client_light_temperature.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
    ...
    <mote>
      ...
      <motetype_identifier>mtype291</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>86.31667181464015</x>
        <y>50.28378115693325</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      ...
      <motetype_identifier>mtype948</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>76.67730849846188</x>
        <y>72.39985285386794</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
      ...
      <interface_config>
        ...
        <history>stop~;A~;stop~;exit~;A~;stop~;A~;stop~;A~;stop~;A~;stop~;A~;stop~;A~;</history>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiRadio
        <bitrate>250.0</bitrate>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>4.555432874566887 0.0 0.0 4.555432874566887 -60.66196823083653 -149.938529772068</viewport>
    </plugin_config>
    <width>400</width>
    <z>4</z>
    <height>400</height>
